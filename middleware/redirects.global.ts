...
const redirects = {
  ...
  "clean-architecture-completely-understood": zennArticleUrl("clean-architecture-completely-understood"),
  "created-the-blog": zennArticleUrl("created-the-blog"),
  ...
  "github-org-profile": zennArticleUrl("github-org-profile"),
  "neovim-clean-config": zennArticleUrl("neovim-clean-config"),
